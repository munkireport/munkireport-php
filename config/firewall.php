...
return [
    ...
    'responses' => [
        ...
        'whitelist' => [
            ...
            'redirect_to' => env('FIREWALL_REDIRECT_DENIED', null),

            'abort' => env('FIREWALL_REDIRECT_DENIED') ? false : true, // return abort() instead of Response::make() - disabled by default
        ],
    ],
    ...
    'redirect_non_whitelisted_to' => env('FIREWALL_REDIRECT_DENIED', false),
