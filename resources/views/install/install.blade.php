...
TARGET_VOLUME=''
CURL=("{{ implode('" "', config('_munkireport.curl_cmd')) }}")
POSTFLIGHT_SCRIPT="{{ config('_munkireport.postflight_script') }}"
REPORT_BROKEN_CLIENT_SCRIPT="{{ config('_munkireport.report_broken_client_script') }}"
# Exit status
ERR=0
...
SCRIPTS=$("${CURL[@]}" "{{ url('/install/get_paths') }}")
