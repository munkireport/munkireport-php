...
MunkiReport Mixed Layout

This layout is only referred to by the laravel/ui authentication scaffolding.
It may be deleted when all the login/logout/password views are migrated.
