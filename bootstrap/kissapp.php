...
// env_helper is autoloaded by composer.json now
...
// config_helper is autoloaded by composer.json now
...
// Replacing with namespaced MR\Kiss classes
//require( APP_ROOT.'/system/kissmvc.php' );

// This is now auto-loaded via composer.json
