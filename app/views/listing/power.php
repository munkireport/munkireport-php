	...
	$(document).on('appReady', function(e, lang) {
	    ...
	    oTable = $('.table').dataTable( {
			...
			if(columnvar === "-9876543" || columnvar === -9876543) {
				 ...
				 $('td:eq(3)', nRow).html(columnvar+' '+i18n.t('power.minute'));
			} else if(columnvar === "0" || columnvar === 0) {
				 $('td:eq(3)', nRow).html(i18n.t('power.never'));
			} else{				 
				 $('td:eq(3)', nRow).html(columnvar+' '+i18n.t('power.minutes'));
			} 
			...
			if(columnvar === "-9876543" || columnvar === -9876543) {
                ...
                if(columnvar === "25" || columnvar === 25 || columnvar === "1" || columnvar === 1) {
				 $('td:eq(7)', nRow).html(i18n.t('power.hibernate')+' ('+columnvar+')');
			} else if(columnvar === "3" || columnvar === 3) {
				 $('td:eq(7)', nRow).html(i18n.t('power.safe_sleep')+' ('+columnvar+')');
			} else if(columnvar === "0" || columnvar === 0) {
				 $('td:eq(7)', nRow).html(i18n.t('power.sleep')+' ('+columnvar+')');
			} else if(columnvar === "-9876543" || columnvar === -9876543) {
				 $('td:eq(7)', nRow).html('');
			} else{
				 $('td:eq(7)', nRow).columnvar;
			}  
			...
			if(columnvar === "-9876543" || columnvar === -9876543) {
				 ...
				 $('td:eq(9)', nRow).html(columnvar+' '+i18n.t('power.minute'));
			} else if(columnvar === "0" || columnvar === 0) {
				 $('td:eq(9)', nRow).html(i18n.t('power.never'));
			} else{				 
				 $('td:eq(9)', nRow).html(columnvar+' '+i18n.t('power.minutes'));
			}
			...
			if(columnvar === "2" || columnvar === 2) {
				 $('td:eq(14)', nRow).html(i18n.t('power.auto_gpu'));
			} else if(columnvar === "1" || columnvar === 1) {
				 $('td:eq(14)', nRow).html(i18n.t('power.discreet'));
			} else if(columnvar === "0" || columnvar === 0) {
				 $('td:eq(14)', nRow).html(i18n.t('power.integrated'));
			} else{
				 $('td:eq(14)', nRow).html("");
			} 
