<div class="col-md-6">
    ...
    <div class="panel panel-default" id="sophos-product-versions-widget">

        <div class="panel-heading">
            <h3 class="panel-title"><i class="fa fa-crosshairs"></i>
            <span data-i18n="sophos.product-versions-title"></span>
...
$(document).on('appReady', function(e, lang) {
    ...
    var conf = {
        url: appUrl + '/module/sophos/get_sophos_product_version_stats',
        widget: 'sophos-product-versions-widget',
