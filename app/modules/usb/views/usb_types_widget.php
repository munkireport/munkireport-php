	...
	<div class="panel panel-default" id="usb-types-widget" onclick="location.href=appUrl+'/show/listing/usb/usb/'">
	...
	$.getJSON( appUrl + '/module/usb/get_usb_types', function( data ) {
		...
		if(data.length){
			$.each(data, function(i,d){
                ...
                box.append('<a href="'+appUrl+'/show/listing/usb/usb/#'+d.type+'" class="list-group-item">'+d.type+badge+'</a>')
			});
		}
		else{
